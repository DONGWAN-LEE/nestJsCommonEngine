...
import * as SHARD0_TABLES from '../database/shard0';
import * as SHARD1_TABLES from '../database/shard1';
import * as SHARD2_TABLES from '../database/shard2';
import * as SHARD3_TABLES from '../database/shard3';
